...
LocalPlayer.CharacterAdded:Connect(function(c)
    ...
    -- reset target เวลา respawn
    currentTarget = nil
    -- ถ้า lock อยู่ → restart เพื่อ re-set CameraType
    if Settings.Enabled then
        task.wait(0.5) -- รอ character load เสร็จ
        if StartLock then StartLock() end
    end
end)
...
MainFrame.Size = UDim2.new(0, S(220), 0, S(354))
MainFrame.Position = UDim2.new(0.5, -S(110), 0.5, -S(177))
...
HeightBox.FocusLost:Connect(function()
    ...
    if v then
        HEIGHT_OFFSET = math.clamp(v, -5, 10)
...
LockBtn.Position = UDim2.new(0, S(8), 0, S(152))
...
NearBtn.Position = UDim2.new(0, S(8), 0, S(186))
...
PrevBtn.Position = UDim2.new(0, S(8), 0, S(218))
...
TargetLabel.Position = UDim2.new(0, S(56), 0, S(218))
...
NextBtn.Position = UDim2.new(0, S(166), 0, S(218))
...
ScanToggleBtn.Position = UDim2.new(0, S(8), 0, S(256))
...
Divider(Content, S(288))

local StatusLabel = Instance.new("TextLabel")
StatusLabel.Size = UDim2.new(1, -S(16), 0, S(20))
StatusLabel.Position = UDim2.new(0, S(8), 0, S(293))
