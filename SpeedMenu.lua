...
main.Size = UDim2.new(0, 220, 0, 340) -- 🔥 ขยาย
...
local function inputBox(placeholder, default, callback)
...
inputBox("Aim Height (-1/0/1)", aimHeight, function(v) aimHeight = v end)
inputBox("Scan Range", scanRange, function(v) scanRange = v end)
inputBox("Lock Range", lockRange, function(v) lockRange = v end)
...
main.Size = collapsed and UDim2.new(0,220,0,40) or UDim2.new(0,220,0,340)
end)
