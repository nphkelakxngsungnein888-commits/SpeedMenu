...
-- ║  SpeedMenu v14                                               ║
-- ║  แก้จาก v12:                                                ║
-- ║  [FIX] Font.Gotham → SourceSans (Ninja ไม่รองรับ Gotham)   ║
-- ╚══════════════════════════════════════════════════════════════╝
...
local function LoadSave()
    ...
    -- [FIX] แก้ logic ที่ผิด: pcall คืน (bool, value) ไม่ใช่ bool เป็น table
...
local function mkBtn(par,txt,sz,pos,bg,tc,ts)
    ...
    b.TextSize=ts or 11;b.Font=Enum.Font.SourceSansBold
...
local function mkLbl(par,txt,sz,pos,ts,tc,xa)
    ...
    l.TextSize=ts or 10;l.Font=Enum.Font.SourceSans
...
local function mkInp(par,def,sz,pos)
    ...
    b.TextSize=11;b.Font=Enum.Font.SourceSans;b.Parent=par
...
TgtLbl.TextColor3=Color3.fromRGB(130,170,255);TgtLbl.TextSize=10;TgtLbl.Font=Enum.Font.SourceSansBold
    ...
    for _,e in ipairs(list) do
        ...
        if not St.espHL[m] then
            ...
            if hrp then
                ...
                dl.TextColor3=Color3.fromRGB(255,255,255);dl.TextSize=11;dl.Font=Enum.Font.SourceSansBold;dl.Text="0m";dl.Parent=bb
            end
